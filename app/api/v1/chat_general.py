...
@router.post("/get-sessions-by-userid", tags= ["Chat_legal Controller"], response_model= List[SessionSummary], status_code=200)
...
@router.post("/get-chathistory-by-sessionid", tags=['Chat_legal Controller'], response_model=List[Message], status_code=200)
...
@router.post("/remove-session", tags=['Chat_legal Controller'], status_code=200)
...
@router.post("/get-latest-session", tags=['Chat_legal Controller'], response_model=List[Message], status_code=200)
...
@router.post("/upvote-chat-session", tags=['Chat_legal Controller'], status_code=200)
...
@router.post("/devote-chat-session", tags=['Chat_legal Controller'], status_code=200)
