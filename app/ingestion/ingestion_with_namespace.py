...
DATASET = "YARGITAY"
INDEX_NAME = "adaletgpt-legalcase-data-v1"
NAME_SPACE = "YARGITAY"
    ...
    try:
        for file_path in load_files_recursively(DATASET):
            ...
            if os.path.getsize(file_path) > MAX_FILE_SIZE:
                ...
                pc.from_documents(chunks, embeddings, index_name=INDEX_NAME, namespace=NAME_SPACE)
            else:
                if data_type == "txt":
                    loader = TextLoader(file_path, encoding="utf-8")
                elif data_type == "pdf":
                ...
                pc.from_documents(documents, embeddings, index_name=INDEX_NAME,namespace=NAME_SPACE)
